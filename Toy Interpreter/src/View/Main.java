...
public class Main {
    ...
    public static void main(String arg[])
    {
        ...
        IExecStack<Statement> stack8 = new ExeStack<>();
        IDictionary<String, Integer> dict8 = new Dictionary<>();
        IList<Integer> l8 = new outputList<>();
        stack8.push(prg8());
        IPrgStateRepo repository8 = new PrgStateRepo(new PrgState(stack8, dict8, l8, new FileTable<>(), new Heap<>(), 8), "prg8.txt");
        ...
        menu.addCommand(new RunExample("8", prg8().toString(), controller8));
        menu.show();
    }
    ...
    private static Statement prg8()
    {
        Statement ex8 = new CompStmt(new CompStmt(new AssignStmt("v",
                new ConstExpr(20)),new ForStmt(new VarExpr("v"),
                new ConstExpr(0),
                new ConstExpr(3),
                new ArithmeticExpr('+',
                        new VarExpr("v"),
